#include "stdafx.h"
#include <bwvr/VrDynamicRenderable.h>
#include <OGRE/OgreCamera.h>
#include <OGRE/OgreHardwareBufferManager.h>

using namespace Ogre;

VrDynamicRenderable::VrDynamicRenderable()
{
}
...
void VrDynamicRenderable::initialize(RenderOperation::OperationType operationType,
                                   bool useIndices)
{
...
void VrDynamicRenderable::prepareHardwareBuffers(size_t vertexCount, 
                                               size_t indexCount)
{
...
Real VrDynamicRenderable::getBoundingRadius(void) const
{
  return Math::Sqrt(std::max(mBox.getMaximum().squaredLength(), mBox.getMinimum().squaredLength()));
}

Real VrDynamicRenderable::getSquaredViewDepth(const Camera* cam) const
{
