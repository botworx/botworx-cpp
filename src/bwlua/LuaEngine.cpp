...
bool LuaEngine::dostring(const char* str) {
	return ::dostring(p_state, str, "noname") == LUA_OK;
}
...
//Singleton support
LuaEngine* LuaEngine::s_singleton = NULL;
LuaEngine& LuaEngine::singleton() {
    if(s_singleton == NULL) {
		s_singleton = new LuaEngine() ;
    }
	return *s_singleton ;
}